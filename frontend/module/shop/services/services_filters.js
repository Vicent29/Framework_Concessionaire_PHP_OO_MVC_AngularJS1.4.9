app.factory('services_filters', ['services',  'services_map', '$rootScope', '$window', function (services,services_map, $scope, $rootScope, $window) {
    let service = { shop_filters: shop_filters, load_brand_filter: load_brand_filter, load_category_filter: load_category_filter, load_motor_filter: load_motor_filter, load_search_filter: load_search_filter, load_orderby_filter: load_orderby_filter, remove_all_filters: remove_all_filters, save_orderby:save_orderby };
    return service;
